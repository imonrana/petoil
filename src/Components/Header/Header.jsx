...
const Header = () => {
  return (
    ...
    <header className='bg-secondary py-4 border-b-4 border-[#FFB800]'>
      <Container>
      {/* header wrapper start */}
     <div className='flex justify-between items-center'>

        {/* contact information start */}
     <div className='flex gap-x-[49px] items-center relative after:contents(" ") after:absolute after:top-1/2 after:left-1/2 after:h-4 after:bg-[#5C6A92] after:w-0.5 after:-translate-x-1/2  after:-translate-y-1/2  '>
