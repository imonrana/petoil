...
const Map = () => {
  return (
   <section>
    ...
    className='w-full h-[200px] md:h-80 lg:h-[450px] border-0'
    ></iframe>
    </div>
    <div className=' bg-primary py-5 md:py-[47px] border-[#FFB800] border-b-[5px] '>
        <Container className =" lg:mx-5 xl:mx-auto">
     <div  className=' flex justify-between items-center flex-col md:flex-row gap-y-5 md:gap-y-0 mx-5 lg:mx-0'>
     <h4 className='font-poppins font-bold text-xl md:text-xl lg:text-2xl xl:text-[36px] text-primaryText  '>
