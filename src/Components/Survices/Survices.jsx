...
const Survices = () => {
  return (
    <section className="mt-7">
      <div className="flex flex-wrap flex-col gap-y-5 md:gap-y-0 md:flex-row justify-between w-full">
      {/* our services text start */}
 
   <Container className="self-center">
   <div className=" font-poppins  md:w-1/2 md:mx-0  ">
        <h4 className="font-bold text-4xl md:text-[64px] text-secondaryText md:w-[421px]  mb-2 md:mb-5">
            Our Services
            </h4>
        <p className="font-medium text-sm md:text-base text-infoText w-[300px] md:w-[405px] mb-5 md:mb-0">
      ...
      {/* services img start */}
      <ServicesImgComponent className=' bg-servicesImgOne bg-no-repeat bg-center bg-cover shrink w-full md:w-1/2'>
       <div className=" ml-[40px] md:ml-[116px]  ">
      ...
      <ServicesImgComponent className=' bg-servicesImgTwo bg-no-repeat bg-center bg-cover shrink w-full md:w-1/2'>
      <div className=" ml-[40px] md:ml-[116px] ">
      ...
      <ServicesImgComponent className=' bg-servicesImgThree bg-no-repeat bg-center bg-cover shrink w-full md:w-1/2'>
      <div className="ml-[40px] md:ml-[116px]] ">
